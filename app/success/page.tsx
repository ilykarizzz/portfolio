...
export default function SuccessPage() {
  useEffect(() => {
    // You could track conversion events here
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#f5f0eb] via-[#e7d9cb] to-[#c9b5a1] dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 text-black dark:text-white flex justify-center items-center p-4">
      ...
      >
        ...
        <h1 className="text-3xl font-bold mb-3">Płatność zakończona pomyślnie!</h1>
        <p className="text-gray-600 dark:text-gray-300 mb-8">
          Dziękujemy za Twoje zamówienie. Skontaktujemy się z Tobą wkrótce, aby omówić szczegóły projektu.
        </p>
